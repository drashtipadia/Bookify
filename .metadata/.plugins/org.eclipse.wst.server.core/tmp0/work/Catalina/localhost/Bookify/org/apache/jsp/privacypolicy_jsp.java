 ...
 * Generated at: 2024-02-25 17:41:47 UTC
...
//	 String error=request.getParameter("registererror");
  ...
  //  	  out.println("<script> registerError();</script>");
   //    }
      ...
      out.write("<P class=\"lead\">At Bookify, we take your privacy seriously. This Privacy Policy outlines the types of personal information we collect, how we use it, and how we protect it.</p>\r\n");
      out.write("<h4>Information We Collect</h4>\r\n");
      out.write("<P>We collect personal information when you contact us by call & email to schedule a domestic help services or when you submit a request for more information through our website contact form. The personal information we collect may include your name, phone number, email address, and address.</p>\r\n");
      out.write("<h4>How We Use Your Information</h4>\r\n");
      out.write("<P>We use your personal information to provide domestic help services, respond to your inquiries, and communicate with you about our services. We may also use your information for marketing purposes, such as sending you promotional emails about our services. You can opt out of these emails at any time.</p>\r\n");
      out.write("<h4>How We Protect Your Information</h4>\r\n");
      out.write("<P>We take the security of your personal information seriously and have implemented industry-standard security measures to protect it.</p>\r\n");
      out.write("<h4>Changes to Privacy Policy</h4>\r\n");
      out.write("<P>We reserve the right to update this Privacy Policy at any time. Any changes will be posted on this page, and your continued use of our services following the posting of changes constitutes your acceptance of those changes.</p>\r\n");
      out.write("<h4>Contact Us</h4>\r\n");
      out.write("<P>If you have any questions about our Privacy Policy or the use of your personal information, please contact us by phone, email, or through our website contact form.</P>\r\n");
      out.write("</div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>\r\n");
      out.write("<!DOCTYPE html>\r\n");
