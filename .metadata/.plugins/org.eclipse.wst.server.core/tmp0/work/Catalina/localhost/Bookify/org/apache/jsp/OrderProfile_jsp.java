 ...
 * Generated at: 2024-02-24 08:52:00 UTC
...
//	 String error=request.getParameter("registererror");
  ...
  //  	  out.println("<script> registerError();</script>");
   //    }
    ...
    ResultSet rsuser;
      ...
      out.write("        </div>\r\n");
      out.write("    </section>\r\n");
      out.write("    <section class=\"mx-5 px-5\">\r\n");
 ...
 rsuser=stuser.executeQuery("SELECT * FROM ordertbl INNER JOIN product ON ordertbl.pro_id=product.pro_id INNER JOIN bill ON ordertbl.bill_id=bill.bill_id INNER JOIN user ON bill.uid=user.uid where bill.uid='"+session.getAttribute("id")+"'");
      ...
      out.write("\r\n");
      out.write("                        <div class=\"card-header mt-3\">\r\n");
      out.write("                            <h3>");
 out.print(rsuser.getString("pro_name")); 
      out.write("</h3>\r\n");
      out.write("                        </div>\r\n");
      out.write("                        <div class=\"card-body\">\r\n");
      out.write("                            <div class=\"row\">\r\n");
      out.write("\r\n");
      out.write("                                <div class=\"col-lg-6 col-md-12  mt-3\">\r\n");
      out.write("                                    <h4 class=\"text-center py-2 bg-light\">Product Details</h4>\r\n");
      out.write("                                    <div class=\"row p-1\">\r\n");
      out.write("                                        <div class=\"col-12\">\r\n");
      out.write("                                           \r\n");
      out.write("                                            <div class=\"row\">\r\n");
      out.write("                                               <h5>Author:  ");
 out.print(rsuser.getString("author")); 
      out.write("</h5>\r\n");
      out.write("                                            </div>\r\n");
      out.write("                                            <div class=\"row\">\r\n");
      out.write("                                                <h5>Publisher: ");
 out.print(rsuser.getString("publisher")); 
      out.write("</h5>\r\n");
      out.write("                                            </div>\r\n");
      out.write("                                            <div class=\"row\">\r\n");
      out.write("                                                <h5>Price: ");
 out.print(rsuser.getString("pro_price")); 
      out.write("</h5>\r\n");
      out.write("                                            </div>\r\n");
      out.write("                                             ");
 if(rsuser.getString("sale").equals("0")) { }else{ 
      ...
      out.write("                                             <div class=\"row\">\r\n");
      out.write("                                                <h5>Sale: ");
 out.print(rsuser.getString("sale")); 
      out.write("</h5>\r\n");
      out.write("                                            </div>\r\n");
      out.write("                                            ");
} 
      out.write("\r\n");
      out.write("                                            <div class=\"row\">\r\n");
      out.write("                                                <h5>Picture:  <img src=\"./images/");
 out.print(rsuser.getString("image")); 
      out.write("\"\r\n");
      out.write("                                                        class=\"img-fluid\" width=\"100\" height=\"100\" /></h5>\r\n");
      out.write("                                            </div>\r\n");
      out.write("                                        </div>\r\n");
      out.write("                                       \r\n");
      out.write("                                    </div>\r\n");
      out.write("                                </div>\r\n");
      out.write("                                <!-- <div width=\"50px\" height=\"50px\">  </div>-->\r\n");
      out.write("                                \r\n");
      out.write("                                <div class=\"col-lg-6 col-md-12 mt-3\">\r\n");
      out.write("                                    <h4 class=\"text-center py-2 bg-light\">User Details</h4>\r\n");
      out.write("                                    <div class=\"row p-1\">\r\n");
      out.write("\r\n");
      out.write("                                            <div class=\"col-12\">\r\n");
      out.write("                                               <div class=\"row\">\r\n");
      out.write("                                                    <h5> Bill Id:");
 out.print(rsuser.getString("bill_id")); 
      out.write(" </h5>\r\n");
      out.write("                                                </div>\r\n");
      out.write("                                                <div class=\"row\">\r\n");
      out.write("                                                    <h5> User Name:");
 out.print(rsuser.getString("name")); 
      out.write(" </h5>\r\n");
      out.write("                                                </div>\r\n");
      out.write("                                                <div class=\"row\">\r\n");
      out.write("                                                    <h5>Address 1: ");
 out.print(rsuser.getString("address1")); 
      out.write("</h5>\r\n");
      out.write("                                                </div>\r\n");
      out.write("                                                <div class=\"row\">\r\n");
      out.write("                                                    <h5>Address 2: ");
 out.print(rsuser.getString("address2")); 
      out.write(" </h5>\r\n");
      out.write("                                                </div>\r\n");
      out.write("                                                <div class=\"row\">\r\n");
      out.write("                                                    <h5>City: ");
 out.print(rsuser.getString("city")); 
      out.write("</h5>\r\n");
      out.write("                                                </div>\r\n");
      out.write("                                                <div class=\"row\">\r\n");
      out.write("                                                    <h5>State:  ");
 out.print(rsuser.getString("state")); 
      out.write(" </h5>\r\n");
      out.write("                                                </div>\r\n");
      out.write("                                                <div class=\"row\">\r\n");
      out.write("                                                    <h5>Quantity:  ");
 out.print(rsuser.getString("orderQty")); 
      out.write("</h5>\r\n");
      out.write("                                                </div>\r\n");
      out.write("                                                <div class=\"row\">\r\n");
      out.write("                                                    <h5>Payment Type: ");
 out.print(rsuser.getString("payment_type")); 
      out.write("</h5>\r\n");
      out.write("					                             </div>\r\n");
      out.write("					                             ");
 if(rsuser.getString("payment_type").equals("card")) { 
      out.write("\r\n");
      out.write("														<div>\r\n");
      out.write("															<h5>Card Holder Name : ");
out.print(rsuser.getString("cardname")); 
      out.write("</h5>\r\n");
      out.write("														</div>\r\n");
      out.write("														<div>\r\n");
      out.write("															<h5>Card Number : ");
out.print(rsuser.getString("cardnumber")); 
      out.write("</h5>\r\n");
      out.write("														</div>\r\n");
      out.write("														<div>\r\n");
      out.write("															<h5>CVV : ");
out.print(rsuser.getString("cvv")); 
      out.write("</h5>\r\n");
      out.write("														</div>\r\n");
      out.write("														<div>\r\n");
      out.write("															<h5>Card Expiry : ");
out.print(rsuser.getString("card_expiry")); 
      out.write("</h5>\r\n");
      out.write("														</div>\r\n");
      out.write("														");
} 
      out.write("\r\n");
      out.write("					                                <div class=\"row\">\r\n");
      out.write("                                                    <h5>Total Amount:  ");
 out.print(rsuser.getString("total_amount")); 
      out.write("</h5>\r\n");
      out.write("                                                </div>\r\n");
      out.write("\r\n");
      out.write("\r\n");
 ...
 if(rsuser.getString("status").equals("Cancel")) { 
      out.write("\r\n");
      out.write("                                    <p class=\"errmsg\">Sorry  Your order canceled...... </p>\r\n");
      out.write("                                	<button class=\"btn allbtn text-white btn-75\">");
 out.print(rsuser.getString("status")); 
      out.write("</button>\r\n");
      out.write("                                		\r\n");
      out.write("                               ");
 }else{ 
 ...
 out.print(rsuser.getString("status")); 
      out.write("</button>\r\n");
      out.write("                                 <a href=\"./ordercancel.jsp?orderid=");
      out.print( orderid );
      out.write("\" class=\"btn allbtn  text-white btn-75\"\r\n");
      out.write("                                                onclick=\"return confirm('Are you sure you want to delete this booking?');\">Cancel</a>\r\n");
      out.write("                                                \r\n");
      out.write("                                                ");
 } 
      out.write("\r\n");
